...
connection = MongoClient("mongodb://PythonUser:Chesterfield@pythoncluster-shard-00-00-cwyta.azure.mongodb.net:27017,pythoncluster-shard-00-01-cwyta.azure.mongodb.net:27017,pythoncluster-shard-00-02-cwyta.azure.mongodb.net:27017/test?ssl=true&replicaSet=PythonCluster-shard-0&authSource=admin&retryWrites=true&w=majority")

def create_mongodatabase():
    try:
        dbnames = connection.database_names()
        if 'test' not in dbnames:
            db = connection.test.users
            db_products = connection.test.products
            db_ratings = connection.test.ratings
            db_api = connection.test.apirelease
